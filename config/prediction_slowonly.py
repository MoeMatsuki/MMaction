...
checkpoint = f"{cdir}/work_dirs/slowonly/20230602_fastlabel/epoch_114.pth" #spatio temporal detection checkpoint file/url
det_config = f"{cdir}/mmaction2/demo/demo_configs/faster-rcnn_r50_fpn_2x_coco_infer.py" #human detection config file path (from mmdet)
