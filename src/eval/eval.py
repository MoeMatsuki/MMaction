...
def process(pre_csv, gt_csv, out_csv, label_name):
    # 定数
...
def main():
    ...
    dir = "/home/moe/MMaction/result_slowfast_val/IMG_0575"
    pre_csv = os.path.join(dir, "test_mmaction.csv")
    out_csv = os.path.join(dir, "low_activity.csv")
    # gt_csv = "/home/moe/MMaction/fastlabel1/annotations/train_rf.csv"
    gt_csv = "/home/moe/MMaction/fastlabel1/annotations/val_rf.csv"
    label_name = list(load_label_map(label).values())

    # Case1
    res = process(pre_csv, gt_csv, out_csv, label_name)
    ...
    #         pre_csv = os.path.join(d_path, "test_mmaction.csv")
    #         out_csv = os.path.join(d_path, "low_activity.csv")
    #         res = process(pre_csv, gt_csv, out_csv, label_name)
    #         if res is not None:
    #             res_list.append(res)
