...
def convert_spatio_label(files, video_id):
    #####
    ...
    for label_dir in label_dirs:
        ...
        for img_dir in img_dirs:
            ...
            if img_dir in val_videos:
                ...
                result_val = result_val + convert_spatio_label(annotation_txt_files, img_dir)
            else:
                result_train = result_train + convert_spatio_label(annotation_txt_files, img_dir)
